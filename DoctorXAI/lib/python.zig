...
pub extern fn futimesat(__fd: c_int, __file: [*c]const u8, __tvp: [*c]const struct_timeval) c_int; // /usr/include/bits/timex.h:81:3: warning: struct demoted to opaque type - has bitfield
...
pub const assert = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /usr/include/assert.h:115:11
pub const assert_perror = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/assert.h:125:11
pub const __ASSERT_FUNCTION = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /usr/include/assert.h:137:12
...
pub const __iscanonicalf = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /usr/include/bits/iscanonical.h:25:9
pub const __iscanonical = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /usr/include/bits/iscanonical.h:26:9
pub const iszero = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /usr/include/math.h:1095:12
...
pub const _Py_XSTRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.11/pymacro.h:35:9
pub const Py_MEMBER_SIZE = @compileError("unable to translate C expr: unexpected token '('"); // /usr/include/python3.11/pymacro.h:44:9
pub const Py_BUILD_ASSERT_EXPR = @compileError("unable to translate C expr: expected ')' instead got '['"); // /usr/include/python3.11/pymacro.h:61:9
pub const Py_BUILD_ASSERT = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.11/pymacro.h:64:9
pub const Py_ARRAY_LENGTH = @compileError("unable to translate macro: undefined identifier `__builtin_types_compatible_p`"); // /usr/include/python3.11/pymacro.h:81:9
pub const PyDoc_VAR = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.11/pymacro.h:92:9
pub const PyDoc_STRVAR = @compileError("unable to translate C expr: unexpected token '='"); // /usr/include/python3.11/pymacro.h:93:9
pub const Py_UNUSED = @compileError("unable to translate macro: undefined identifier `_unused_`"); // /usr/include/python3.11/pymacro.h:120:11
...
pub const PyModule_AddIntMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.11/modsupport.h:63:9
pub const PyModule_AddStringMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.11/modsupport.h:64:9
